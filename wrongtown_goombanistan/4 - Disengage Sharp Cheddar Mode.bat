...
echo.
echo.
echo Press any key to disengage SHARP CHEDDAR MODE and revert to the normal Goombanistanian mod.
echo.
...
copy ..\wrongtown_goombanistan\character.json.bak ..\wrongtown_goombanistan\character.json
pause